...
#        print x
    ...
    print ("</td><td> <img src=\"/static/centralflux.png\">  </td>        </tr>      </table>")
...
#        print Vector_local 
    ...
    print("""</p>\
    <p>Using RBF kernel SVM as regressor. Parameters vary for different fluxes. For details, refer to <a href="/static/svr_both_rbf_shuffle.log">this document generated by grid search on SVM parameters</a>. </p>
